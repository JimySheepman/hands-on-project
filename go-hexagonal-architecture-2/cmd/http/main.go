...
import (
	...
	_ "go-pos/docs"
	cache "go-pos/internal/adapter/cache/redis"
	handler "go-pos/internal/adapter/handler/http"
	repo "go-pos/internal/adapter/repository/postgres"
	token "go-pos/internal/adapter/token/paseto"

	"go-pos/internal/core/service"
...
// @contact.name		    go-pos
// @contact.url				go-pos
// @contact.email			go-pos
//
// @license.name				MIT
// @license.url				go-pos/blob/main/LICENSE
//
// @host						go-pos
// @BasePath					/v1
// @schemes					http https
