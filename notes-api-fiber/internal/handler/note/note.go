...
import (
	...
	"notes-api-fibe/internals/model"
)
...
func GetNotes(c *fiber.Ctx) {
	...
	if len(notes) == 0 {
		return c.Status(404).JSON(fiber.Map{"status": "error", "meesage": "No notes present", "data": nill})
	}
	// Else return notes
...
func CreateNote(c *fiber.Ctx) error {
	...
	// Strore the body in the note and return error if encountered
